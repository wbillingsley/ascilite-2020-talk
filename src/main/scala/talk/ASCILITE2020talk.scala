...
object ASCILITE2020talk {
  ...
  val deck = new DeckBuilder()
    ...
    .ppImageSlide(
      ...
      caption = "UNE, Armidale, NSW, Australia. 85% of students online.", cover=true
    )
    .landscapeImageSlide(
      image="images/workshop/coderchallenge2018.jpg",
      caption="UNE Cisco Coders Challenge 2018", cover=true
    )
    .landscapeImageSlide(
      image="images/workshop/coderchallenge tam 2019.jpg",
      caption="UNE Cisco Coders Challenge 2019, Peel High School, Tamworth", cover=true
    )
    .landscapeImageSlide(
      image="images/workshop/coderchallenge asc 2019.jpg",
      caption="UNE Cisco Coders Challenge 2019, Armidale Secondary College", cover=true
    )
    .landscapeImageSlide(
      image="images/workshop/scienceexperience2019.jpg",
      caption="ConocoPhillips Science Experience 2019.", cover=true
    )
    .landscapeImageSlide(
      image="images/workshop/faroutscience2019.jpg",
      caption="Far Out Science, The Coding Escape, Tamworth 2018.", cover=true
    )
    .markdownSlide(
